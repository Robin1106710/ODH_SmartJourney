...
class generation_input:
    def __init__(self, historial:bool , shopping:bool , literature_art:bool ,
                    family:bool , educational:bool , pace:float,start_point_ID:int,
                    time_limit:int):
        ...
        self.pace = pace # multiplier of the estimate time
...
input= generation_input(True,False,False,False,True , 1,32,100)
generate_path(input)
